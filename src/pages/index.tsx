...
export default function HomePage() {
  return (
    <div className="pb-16">
      {/* Hero */}
      <section className="relative left-1/2 mb-10 w-screen -translate-x-1/2 overflow-hidden bg-black min-h-[600px] py-32 text-white sm:py-24 md:h-[730px] md:py-0 lg:flex lg:h-[730px] lg:flex-row lg:items-center">
        ...
        <div className="relative mx-auto w-full max-w-[1440px] px-4 text-center sm:px-6 md:flex md:flex-row md:items-center md:gap-8 lg:px-8 lg:text-left">
